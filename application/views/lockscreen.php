...
<html>
    <head>
        ...
        <title><?php echo $data[0]['title']; ?> - doctor appoinment system</title>
        <meta content="doctor appointment system" name="description" />
            ...
            <div class="card">
                <div class="card-block">
                    <h3 class="text-center m-0">
                        <a href="#" class="logo logo-admin"><img src="<?php echo base_url(); ?>assets/images/system.jpg" height="30" alt="logo"></a>
                    </h3>
                    <div class="p-3">
                        ...
                        <form class="form-horizontal m-t-30" method="post" action="<?php echo base_url('user_operation/login'); ?>">
                            <div class="user-thumb text-center m-b-30">
                                <img src="<?php echo base_url(); ?>assets/images/users/male.png" class="rounded-circle img-thumbnail" alt="thumbnail">
