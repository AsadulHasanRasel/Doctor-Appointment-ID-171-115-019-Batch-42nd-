...
<html>
    <head>
        ...
        <meta content="doctor appointment" name="description" />
        ...
        <div class="container account-sign">
            <div class="card">
                <div class="card-block">
                    <div class="p-3">
                        <h4 class="text-muted font-18 m-b-5 text-center">welcome to doctor appointment system</h4>
            ...
            <div class="m-t-40 text-center">
                <p class="text-white">© <?php echo date('Y'); ?> doctor appointment system. <br> Crafted with <i class="mdi mdi-heart text-danger"></i> by Landinghub</p>
            </div>
