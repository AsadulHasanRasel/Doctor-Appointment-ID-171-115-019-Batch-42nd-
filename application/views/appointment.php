            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="m-b-20">
                            <!-- Large modal -->
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".new_appoinment"><i class="fa fa-check"></i>&nbsp; New Appoinment</button>
                        </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div>
                                            <div class="row">
                                                <a href="<?php echo base_url('user/addpatient'); ?>"><button type="button" class="btn btn-primary waves-effect waves-light" style="margin-left:20px;"><i class="fa fa-check"></i>&nbsp; New Patient</button></a>
                                            </div>
